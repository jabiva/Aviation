<!-- Header start -->
<title><?php echo('Edit Aircraft'); ?></title>
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `aircraft` SET `aircraft`='$aircraft',`registration`='$registration',`engine`='$engine',`seater`='$seater',`flyable`='$ground',`checking`='$checking' WHERE id=$id";
    ...
    if($result)
    {
        ...
        header("location: aircraft.php?msg=Update Aircraft Information Successful");
...
?>
    ...
    <?php 
        ...
        $sql = "SELECT * FROM `aircraft` WHERE id = $id LIMIT 1";
        $result = mysqli_query($conn,$sql);
        ...
        <div class="container">
            <form class="row g-3 mx-5" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <select id="engine" name="engine" class="form-select" value="<?php echo $row['engine'] ?>">
                ...
                <div class="col-md-6">
                    ...
                    <select id="seater" name="seater" class="form-select" value="<?php echo $row['seater'] ?>">
                ...
                <div class="col-md-6">
                    ...
                    <select id="ground" name="flyable" class="form-select" value="<?php echo $row['flyable'] ?>">
                        <option>300NM</option>
                        <option>AOG</option>
                        <option></option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select id="checking" name="checking" class="form-select" value="<?php echo $row['checking'] ?>">
                        <option>TBO</option>
                        <option></option>
                    </select>
                </div>
