        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="aircraft.php" class="dropdown-item active">View Aircraft</a>
                </div>
        ...
        <div class="container">
            <form class="row" method="post">
                ...
                <div class="col-lg-8 col-md-7 col-sm-6 col-3">
                    <a href="add_aircraft.php"><input type="button" name="submit" value="Add Aircraft"
                ...
                <table class="table table-warning table-striped table-bordered text-center">
                    <thead class="table-warning">
                        <tr>
                            ...
                            <th scope="col">Ground Aircraft</th>
                            <th scope="col">Checking Aircraft</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <?php echo $row['flyable'] ?></td>
                            <td> <?php echo $row['checking'] ?></td>
                            <td>
                                <a href="edit_aircraft.php?id=<?php echo $row['id'] ?>" class="link-dark"><i
                                        class="fa-duotone fa-pen-to-square me-3"></i></a>
                                <a href="delete_aircraft.php?id=<?php echo $row['id'] ?>" id="del" class="link-dark"><i
